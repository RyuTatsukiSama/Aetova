...
For logger gestion in C++ : [docLogger](https://github.com/RyuTatsukiSama/docLogger) v1.1.1

For logger gestion in Golang : [docLogger](https://github.com/RyuTatsukiSama/docLogger) v1.0.0
