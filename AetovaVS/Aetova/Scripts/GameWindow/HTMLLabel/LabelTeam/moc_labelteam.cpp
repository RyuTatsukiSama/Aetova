/****************************************************************************
** Meta object code from reading C++ file 'labelteam.h'
**
...
#error "The header file 'labelteam.h' doesn't include <QObject>."
...
Q_CONSTINIT const QMetaObject TeamLabel::staticMetaObject = { {
    QMetaObject::SuperData::link<HTMLLabel::staticMetaObject>(),
...
void *TeamLabel::qt_metacast(const char *_clname)
{
    ...
    return HTMLLabel::qt_metacast(_clname);
}

int TeamLabel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = HTMLLabel::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
