...
static constexpr auto qt_meta_stringdata_ZN16BackgroundWidgetE = QtMocHelpers::stringData(
    "BackgroundWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16BackgroundWidgetE[] = {
...
Q_CONSTINIT const QMetaObject BackgroundWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16BackgroundWidgetE.offsetsAndSizes,
    qt_meta_data_ZN16BackgroundWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16BackgroundWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<BackgroundWidget, std::true_type>
    >,
    nullptr
} };
...
void *BackgroundWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16BackgroundWidgetE.stringdata0))
